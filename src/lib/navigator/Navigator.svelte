...
<div class="grid grid-cols-4 lg:grid-cols-8 gap-8 justify-between">
    ...
    <Language src="/logos/Ruby.svg" name="Ruby" />
    <Language src="/logos/Java.svg" name="Java" />
    <Language src="/logos/Rust.svg" name="Rust" />
    <Language src="/logos/CSharp.svg" name="C#" />
    <Language src="/logos/Swift.svg" name="Swift" />
</div>